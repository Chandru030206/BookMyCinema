/**
 * Movie Ticket Booking System - Dummy Data
...
const theatersData = [
    {
        ...
        screens: [
            { id: 1, name: "Screen 1 - IMAX", capacity: 300, type: "imax" },
            { id: 2, name: "Screen 2 - 4DX", capacity: 150, type: "4dx" },
            { id: 3, name: "Screen 3", capacity: 200, type: "regular" }
        ]
    },
    {
        id: 2,
        ...
        distance: "4.2 km",
        facilities: ["Dolby Atmos", "Food Court", "Parking", "Wheelchair Access"],
        screens: [
            { id: 1, name: "Audi 1", capacity: 250, type: "premium" },
            { id: 2, name: "Audi 2", capacity: 200, type: "regular" },
            { id: 3, name: "Audi 3", capacity: 180, type: "regular" }
        ]
    },
    {
        id: 3,
        ...
        distance: "6.8 km",
        facilities: ["3D", "Premium Lounge", "Online Booking", "Snack Bar"],
        screens: [
            { id: 1, name: "Hall A", capacity: 280, type: "premium" },
            { id: 2, name: "Hall B", capacity: 220, type: "regular" }
        ]
    },
    {
        id: 4,
        ...
        distance: "1.8 km",
        facilities: ["Recliner Seats", "Couples Seats", "Snack Bar"],
        screens: [
            { id: 1, name: "Screen 1", capacity: 150, type: "boutique" },
            { id: 2, name: "Screen 2", capacity: 120, type: "boutique" }
        ]
    }
];
...
const filterOptions = {
    ...
    genres: ["All", "Action", "Adventure", "Animation", "Comedy", "Crime", "Drama", "Horror", "Sci-Fi", "Thriller"],
    formats: ["All", "2D", "3D", "IMAX", "4DX", "Dolby Cinema"]
};
...
const MovieData = {
    ...
    getTheaterById: function(id) {
        return this.theaters.find(theater => theater.id === parseInt(id));
    },
    
    getShowtimes: function(theaterId) {
        return this.showtimes[theaterId] || [];
    },
    ...
    filterMovies: function(language, genre) {
        return this.movies.filter(movie => {
